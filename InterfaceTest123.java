...

{
	...
	FighterFlight(int a,String airline, String sc,String dc, int tm,int am,int fm ) {
		super(a,airline,sc,dc);
		totalMissiles = tm;
		armMissiles=am;
		fireMissiles=fm;
		System.out.println("FighterFlight(int,String,String,String,int,int,int)");
	}
	void showFighterFlight() {
		super.showFlight();
		System.out.println("Total Missiles	: "+totalMissiles);
		System.out.println("Total  arm Missiles	: "+armMissiles);
		System.out.println("Total fire Missiles	: "+fireMissiles);

@Override
	public void checkLatitude() {
		// TODO Auto-generated method stub
		System.out.println("Fire Flight is checking its.... latitude...");
	}
	@Override
	public void checkAltitude() {
		// TODO Auto-generated method stub
		System.out.println("Fire Flight is checking its.... altitude...");
	}
	@Override
	void fly() {
		// TODO Auto-generated method stub
		System.out.println("Fire Flight is flying.....");
		 checkAltitude();
		 checkLatitude();
	}
	@Override
	void land() {
		// TODO Auto-generated method stub
		System.out.println("Fire Flight is landing........");
	}
